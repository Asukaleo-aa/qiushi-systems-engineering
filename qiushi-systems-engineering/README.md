...
一套为 AI Agent 设计的方法论 skill 集合。27 个 skill 覆盖 agent 认知闭环的七个环节——从感知到修正，使 agent 在面对复杂任务时能够：
...
| Skill | 一句话 | 来源 |
|-------|--------|------|
| `investigation-first` | 先调查再发言，列提纲逐项摸清 | 毛泽东《反对本本主义》 |
| `problem-domain-investigation` | 进入陌生领域前的系统性调研 | 钱学森《论系统工程》 |
...
- v1.0：初始版本，11 个 qiushi 技能
- v2.0：新增系统工程层和工程控制论层，24 个技能
- v2.1：新增最优决策、状态估计、自适应策略，27 个技能
- v3.0：重构为认知环架构，以 agent 认知闭环替代来源分层
- v3.1：引入系统层次意识（物理/工程/产品/社会-技术），在网关判据、系统思维框架、第一性分析、边界结构、约束优化、综合集成、反馈修正等七个关键节点增加层次锚定与校验机制。防止"把产品当物理系统优化"类层次错位错误
...
- 将 11 个技能扩展至 28 个，重构为七环认知闭环架构
- v3.1 引入系统层次意识，防止方法论层面的层次错位
